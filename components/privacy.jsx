    ...
    return ( 
        ...
        <Container className="my-5">
            <Row class="col-lg-10 mx-auto lead">
                ...
                <h3 id="Digital Millennium Copyright Act (DMCA)">Digital Millennium Copyright Act (DMCA)</h3>
                    <hr></hr>
                    <p> We respect the intellectual property rights of others and expect our users to do the same. If you believe that any content on our website infringes your copyright, please contact us immediately, with the following information:</p>
                    <ul>
                ...
                <h3 id="California Consumer Privacy Act (CCPA)">California Consumer Privacy Act (CCPA)</h3>
                    <hr></hr>
                    <p> Under the CCPA, California residents have certain data protection rights, including:</p>
                    <ul>
                        <li> The right to know what personal information we have collected about you and how it was used;</li>
                    ...
                    <p> If you are a California resident and would like to exercise your CCPA rights, please contact us. We may ask you to verify your identity before responding to your request.</p>
                    <p> Please note that we do not sell your personal information.</p>
                <h3 id="Information sharing">Information sharing and disclosure</h3>
                    <hr></hr>    
                    <p>We may share your information with third-party service providers who assist us with our business operations, such as website hosting, payment processing, and data analysis. We may also share your information in response to a legal request, such as a subpoena or court order, or to protect our rights or the rights of others.</p>
                ...
                <h3 id="Security">Security</h3>
                    <hr></hr>
                    <p>We take reasonable measures to protect the personal information we collect from unauthorized access, use, and disclosure. However, no method of transmission over the internet or electronic storage is completely secure, and we cannot guarantee the absolute security of your information.</p>

                <h3 id="Childrens Privacy">Children's privacy</h3>
                    <hr></hr>
                    <p>Our Site does not address anyone under the age of 18 ("Children"). We do not knowingly collect personally identifiable information from children under 18. If you are a parent or guardian and you are aware that your child has provided us with Personal Information, please contact us. If we become aware that we have collected Personal Information from children under 18 without verification of parental consent, we take steps to remove that information from our servers.</p>

                <h3 id="Changes to policy">Changes to this policy</h3>
                    <hr></hr>
                    <p>We may update this privacy policy from time to time by posting a new version on our website. You should check this page occasionally to ensure you are comfortable with any changes.</p>
